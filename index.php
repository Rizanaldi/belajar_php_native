...
<body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <?php 
            $get = mysqli_query($c,"SELECT * FROM pesanan p, pelanggan pl WHERE p.idpelanggan = pl.idpelanggan ORDER BY tanggal DESC");
        ...
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <div class="p-3">
                <div class="grid grid-cols-5 w-full">
                    ...
                    <div class="col">
                        <button onclick="openModal('main-modal')" class="text-sm w-full text-white hover:bg-blue-700 bg-blue-500 p-1 rounded font-bold">+ Tambah <?=$judul;?> Baru</button>
                    </div>
                </div>
                ...
                <table class="w-full mt-3 p-1 table-auto">
                    <thead class="bg-red-500 text-white text-center">
                      <tr class="border">
                        ...
                        <th class="border p-1">Id Pesanan</th>
                        <th class="border p-1">Tanggal / Waktu</th>
                        <th class="border p-1">Nama & Alamat Pelanggan</th>
                        <th class="border p-1">Jumlah Jenis Barang</th>
                    ...
                    <tbody class="text-center">
                        <?php 
                            ...
                            $hitung_jumlah = mysqli_query($c, "SELECT * FROM detailpesanan WHERE idpesanan = '$idpesanan' ");
                            $jumlah_jenis = mysqli_num_rows($hitung_jumlah);
                        ?>
                        
                        <tr class="border hover:bg-red-100  ">
                            <td class="border p-1"><?=$i++; ?></th>
                            <td class="border p-1"><?=$idpesanan; ?></th>
                            <td class="border p-1"><?=$tanggal; ?></td>
                            <td class="border p-1"><p class="font-bold"><?=$namapelanggan;?></p><p class="text-xs"><?=$alamat;?></p></td>
                            <td class="border p-1"><?=$jumlah_jenis; ?></td>
                            <td class="border p-1">
        ...
        <div class="border border-blue-500 shadow-lg modal-container bg-white w-4/12 md:max-w-11/12 mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <form method="post" class="w-full">
                    <!--Body-->
                    <div class="p-1 flex">
                        <p class="p-3 font-bold">Pilih Pelanggan : </p>
                        <select name="idpelanggan" class="border border-black rounded bg-gray-100">
                            <?php 

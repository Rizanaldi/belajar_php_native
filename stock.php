        ...
        <div class="bg-gray-800 shadow-xl h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48">
            <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="stock.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-red-500"> 
                            <i class="fas fa-cubes pr-0 md:pr-3 text-red-500"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-red-500 font-bold block md:inline-block">Stock Barang</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                ...
                <div class="grid grid-cols-5 w-full">
                    <div class="col-span-4 mr-3">
                        <div class="flex rounded font-bold bg-gradient-to-r from-red-500 p-1 ">
                            <span class="text-sm text-white">Jumlah <?=$judul;?> : <span> 
                            <span class="text-2xl bg-gray-100 text-red-500 p-1 rounded"><?=$jumlah_data;?></span>
                        </div>
                    </div>
                    <div class="colt">
                        <button onclick="openModal('main-modal')" class="modal-open text-sm w-full text-white hover:bg-blue-700 bg-blue-500 p-1 rounded font-bold">+ Tambah <?=$judul;?> Baru</button>
                    </div>
                </div>
                ...
                <table class="w-full mt-3 p-1 table-auto">
	                ...
	                <tbody class="text-center">
		                ...
		                <tr class="border hover:bg-red-100  ">
		                    ...
		                    <td class="border p-1"><?=$namaproduk; ?></td>
		                    <td class="border p-1"><?=$deskripsi; ?></td>
		                    <td class="border p-1"><?=$stock; ?></td>
		                    <td class="border p-1"><span class="bg-yellow-500 rounded text-white text-sm">Rp.</span> <?=number_format($harga, 0,',','.')?></td>
		                    <td class="border p-1">
		                    	
		                    	<a href="stock.php?act=2<?=$idproduk;?>" class="rounded hover:bg-purple-500">
		                    		<i class="fas text-purple-500 hover:text-white p-1 fa-pencil-square"></i>
		                    	</a>
		                    	<button class="rounded hover:bg-red-500">
            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                <form method="post">
                    ...
                    <div class="flex justify-end p-3">
                      <button class="p-1 rounded text-green-500 hover:text-white hover:bg-green-700 mr-3" type="submit" name="tambah_barang">
...
<?php 
    if($idp > 0 && $idm == 2 ){
        $get = mysqli_query($c,"SELECT * FROM produk where idproduk = '$idp' ");
        ...
        <div class="border border-blue-500 shadow-lg modal-container bg-white w-4/12 md:max-w-11/12 mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <form method="post">
                    ...
                    <label class="text-black text-sm font-bold"> Nama Produk</label>
                    <input required value="<?=$namaproduk ;?>" type="text" class="form-control shadow border rounded w-full p-1 mb-3 text-sm text-black focus:outline-none focus:shadow-outline" placeholder="Nama Produk" name="namaproduk"/>
                    <label class="text-black text-sm font-bold"> Deskripsi</label>
                    <input required value="<?=$deskripsi ;?>" type="text" class="form-control shadow border rounded w-full p-1 mb-3 text-sm text-black focus:outline-none focus:shadow-outline" placeholder="Deskripsi" name="deskripsi"/>
                    
                    <label class="text-black text-sm font-bold"> Harga Produk</label>
                    <input required value="<?=$harga ;?>" type="number" class="form-control shadow border rounded w-full p-1 mb-3 text-sm text-black focus:outline-none focus:shadow-outline" placeholder="Harga Produk : Rp..." name="harga"/>

                    <!--Footer-->
                    <div class="flex justify-end p-3">
                      <button class="p-1 rounded text-green-500 hover:text-white hover:bg-green-700 mr-3" type="submit" name="update_product">
                        <i class="fas fa-check-square"></i>
                      </button>
                      <a class="p-1 rounded text-red-500 hover:text-white hover:bg-red-700" href="stock.php" >
                        <i class="fas fa-window-close"></i>
                      </a>
                    </div>
                </form>
...
<?php 
    if($idp > 0 && $idm == 3 ){
        $get = mysqli_query($c,"SELECT * FROM produk where idpelanggan = '$idp' ");
        $p = mysqli_fetch_array($get);
        ...
        <div class="border border-blue-500 shadow-lg modal-container bg-white w-4/12 md:max-w-11/12 mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <form method="post">
                    ...
                    <p class="p-1">Anda yakin ingin menghapus produk dengan nama 
